...
public class MantenimientoPK implements Serializable {
    ...
    public MantenimientoPK(int idVehiculo, int idEstandarVehiculo) {
    ...
    public String toString() {
        return "com.kradac.karview.entitis.MantenimientoPK[ idVehiculo=" + idVehiculo + ", idEstandarVehiculo=" + idEstandarVehiculo + " ]";
    }
